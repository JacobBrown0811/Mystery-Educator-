  ...
  return (
    <div className="About">
      ...
      <div className="group-container">
        ...
        <a href="https://github.com/Zebleya1" >GitHub Profile</a>
        ...
        <div className="group-box">
          ...
          <a href="https://github.com/obonn1" >GitHub Profile</a>
        ...
        <div className="group-box">
          ...
          <a href="https://github.com/nmange95">GitHub Profile</a>
          <p>Back-End Development</p>
        ...
        <div className="group-box">
          ...
          <a href="https://github.com/GONZ997">GitHub Profile</a>
          <p>Front-End Development</p>
        ...
        <div className="group-box">
         <img src={require("./Images/jacob.jpg")} alt="Jacob's pfp" className="team-image"/>
          ...
          <a href="https://github.com/JacobBrown0811">GitHub Profile</a>
          </div>
          <p>Front-End Development</p>
